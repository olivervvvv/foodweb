...
<template>
  ...
  <!-- 	高雄 -->
  <path id="TWN1156" class="st0" d="M739.8,786.9l1.9,5.8l-3,5l-5.6,2.4l-1.4,3.2l1,4l5.6,3.6l6.3,5.2l2.8,7.6l0.3,2.5l-15.6,3.8
  ...
  <!-- 屏東	 -->
  <path id="TWN1158" class="st0" d="M569.4,1095.6l2,2.9l-0.3,1l-2.7,1.8l-5,4.3l-0.9-3.3l1.4-2.7l2.8-3.6h2L569.4,1095.6
  ...
  <!-- 台南	 -->
  <path id="TWN1160" class="st0" d="M483.8,897.9l-0.6,1.2l-2.3-2l-1.7-4.2l0.3-1.3h0.7l0.9,1.2l0.7,1.9l2.1,2.2L483.8,897.9
    ...
    L643.6,846.5z"/>
  <!-- 新竹市	 -->
  <path id="TWN1161" class="st0" d="M724.3,418.6l-0.2,0.2l-4.6,1.1l-4.4-1.7l-2.7-3.8l-4.3-2.6l-6.9-2.7l1.2-4.1l5.5-11.4l2.2-3
  ...
  <!-- 新竹縣	 -->
  <path id="TWN1162" class="st0" d="M843.1,453.2l-2.3,6.5l-1.4,4.7l0.6,4.4l-3.8,5.8l-14,14.2l-4.3,10.5l-2.8-0.8l-10.6,1l-0.8,0.6
  ...
  <!-- 宜蘭 -->
  <path id="TWN1163" class="st0" d="M982.4,378.5l2.1,0.5l1.6,2.2l-0.7,2.3l-3.8-0.1l-1.4-0.8l-1.7-2.7l0.9,0.3L982.4,378.5
    ...
    L935.4,531.1z"/>
  <!-- 基隆	 -->
  <path id="TWN1164" class="st0" d="M934.8,294.6l-0.3,11.9l0.2,3l3.7,3.9l-0.4,2.5l-2.5,1.8l-4,1.5l-5.1-0.6l-10.6-4.4l-3-2.2
    l-3.7-3.4l-2.8-3.5l-1.7-3.5l-2.9-3.7l-0.6-2.9l3.2-2.2l7.2-3.1l4.4-2.9l1.4,0.9l2.4,2.7l3.9,1.4L934.8,294.6L934.8,294.6z"/>
  <!-- 苗栗	 -->
  <path id="TWN1165" class="st0" d="M724.3,418.6l4.4,11.1l3.9,4.4l6,4.5l12.1,5.7l3.9,3.4l0.7,5.2l-0.3,3.9l-0.8,3.5l-1,3.1l1,2.9
  ...
  <!-- 台北	 -->
  <path id="TWN1166" class="st0" d="M897.4,342.8l-4.2,1.7l-5.8-0.1l-4.8-1l-3.7-3.3l-3.8-4.3l-5.8-4.6l-3.9-6.7l1.5-7.4l-1.2-6.3
  ...
  <!-- 新北	 -->
  <path id="TWN1167" class="st0" d="M915.9,286.8l-4.4,2.9l-7.2,3.1l-3.2,2.2l0.6,2.9l2.9,3.7l1.7,3.5l2.8,3.5l3.7,3.4l3,2.2l10.6,4.4
  ...
  <!-- 桃園	 -->
  <path id="TWN1168" class="st0" d="M861.8,428.4l-3.1,0.9l-5.4,3.9l3.1,12.4l-2.2,3.8l-3.4,1.3l-3.3-0.6l-3.9,1.6l-0.5,1.5l-4.8-2.2
  ...
  <!-- 彰化	 -->
  <path id="TWN1169" class="st0" d="M647.2,619.2l0.1,3.6l-4.3,1.6l-1.2,2.9l0.5,4l-2,4.6l-1.6,5.4l-0.1,5.7l-1.2,6.6l-0.9,13.4
  ...
  <!-- 嘉義縣	 -->
  <path id="TWN1170" class="st0" d="M499.6,822.8l-1.8,1.4l-0.4-1.1l2.4-3.1l0.9-2.4l1.1-1.5l0.6,0.5l0.1,1.1l-1.4,2L499.6,822.8
  ...
  <!-- 嘉義市 -->
  <path id="TWN1171" class="st0" d="M573.8,766.1l9.3-1.6l7.8-0.7l5.6,2.1l4.1,2.2l2.5,4l2.5,6.8l-3,2.2l-4.5,0.6l-6.8,2.7l-7.3-1.7
    l-7-4.5l-6.1-2.4l-0.9-5.6L573.8,766.1L573.8,766.1z"/>
  <!-- 花蓮	 -->
  <path id="TWN1172" class="st0" d="M935.4,531.1l0.6,0.8l1.6,2.9l0.2,1.1l-1.4,2.4l-5.8,5.7l-6.2,8.6l-4.7,3.7l-1.4,2l0.7,2.1
  ...
  <!-- 南投	 -->
  <path id="TWN1173" class="st0" d="M825,557.2l1.4,6.2l0.2,3.7l-5.2,2.4l-6.6,2.2l-3.7,2.9l0.2,9.9l2.9,3.1l5.2,3.4l1.5,4.5l-0.3,3.9
  ...
  <!-- 台中 -->
    <path id="TWN1174" class="st0" d="M803.7,500.1l0.8-0.6l10.6-1l2.8,0.8l3.6,1l-0.6,5.5l1.4,3.8l4.9,1l4.4,2.6l3.7,2.5l4-0.6l4.7-2.3
  ...
  <!-- 雲林 -->
    <path id="TWN1176" class="st0" d="M642,689.8l1.9,7.2l-2,4.7l-1,7.2l1,7.7l-1.9,5.2l-0.9,5.7l4,4.7l5.8,2.5l6.8-2l8.2-0.9l2.6,3.5
  ...
  <!-- 台東	 -->
  <path id="TWN1177" class="st0" d="M889.2,1192.6l-5.5,1.7l-7.3-2.9l-6.8-4.8l-3.9-3.7l1.2-2.7l-0.1-2.5l-1-2.4l-1.7-2.1h19.5v1.8
  ...
  <!-- 澎湖	 -->
  <path id="TWN3414" class="st0" d="M320.7,856.1l-1.8,0.9l-1.3-1.5l-1.5-4.7l1-1.2l3.8-1.3l2.7,0.7l0.1,2.1l-0.2,1.6l-1.2,1.2
