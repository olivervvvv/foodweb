...
<template>
  <div style="display: flex;align-items: center" class="maincon">
    ...
    l6.9,2.7l4.3,2.6l2.7,3.8l4.4,1.7l4.6-1.1L724.3,418.6L724.3,418.6z" />
        ...
        <!-- 臺北	 -->
        <path id="臺北市" @click="handlePathClick" class="st0" d="M897.4,342.8l-4.2,1.7l-5.8-0.1l-4.8-1l-3.7-3.3l-3.8-4.3l-5.8-4.6l-3.9-6.7l1.5-7.4l-1.2-6.3
    ...
    l-7-4.5l-6.1-2.4l-0.9-5.6L573.8,766.1L573.8,766.1z" />
        <!-- 花蓮	 -->
        <path id="花蓮" @click="handlePathClick" class="st0"
    ...
    l12.2,6l5.8-0.1l12,2.4L642,689.8L642,689.8z" />
        <!-- 臺東	 -->
        <path id="臺東縣" @click="handlePathClick" class="st0" d="M889.2,1192.6l-5.5,1.7l-7.3-2.9l-6.8-4.8l-3.9-3.7l1.2-2.7l-0.1-2.5l-1-2.4l-1.7-2.1h19.5v1.8
