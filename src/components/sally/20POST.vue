        ...
        <div class="instagram-post" v-for="(post, index) in items" :key="index">
            ...
            <div class="header">
                <figure style="height:32px;width: 32px;margin-right: 2%;">
                    ...
                    <img :src="getImage(post.user.picture)" style="height: auto;width: 100%;border-radius: 99px;"
                        v-if="getImage(post.postInfo.picture)">
                    <!-- 預設發文者圖片 -->
                    <img src="../../main/resources/static/images/explorer.png"
                        style="height: auto;width: 100%;border-radius: 99px;" v-else>
                </figure>
                <!-- 讀取發文者名子 -->
            ...
            <div>
                <div>
                    <figure>
                        ...
                        <img :src="getImage(post.postInfo.picture)" style="height: 100%; width: 100%;"
                            v-if="post.postInfo.picture">
                        <!-- 如果base64為空,則檢查路徑 -->
                        <img :src="post.postInfo.filePath" style="height: 100%; width: 100%;"
                            v-if="post.postInfo.picture === null">
                        <!-- 預設貼文圖片 -->
                        <img src="../../main/resources/static/images/error 404.png" style="height: 100%; width: 100%;"
            ...
            <div class="content">
                <div class="heart">
                    ...
                    <i v-if="post.isLiked" class="fa-solid fa-heart fa-lg" style="color: #ff0000;"
                        @click="clickLike(post)"></i>
            ...
            <div class="comment-preview">
                <div v-for="(comment, cIndex) in post.comments" :key="cIndex">
                    <span style="font-weight: bold;">{{ comment.postComment.name }}</span>
                    <p>{{ comment.postComment.comment }}</p>
                </div>
                <!-- 顯示完整評論btn -->
                <button class="blue-city-btn"
                    @click="showComment(post.postInfo.postId, post.postInfo.storeId)">顯示完整評論</button>
            </div>
        </div>
                    ...
                    <div class="content" v-for="(comment, index) in commentData" v-if="commentData.length > 0">
                        <div style="display: flex;align-items: center">
                            ...
                            <figure style="height:32px;width: 32px;">
                                ...
                                <img :src="getImage(comment.userPicture)"
                                    style="height: auto;width: 100%;border-radius: 99px;"
                                    v-if="getImage(comment.userPicture)">
                                <!-- 預設留言者圖片 -->
                                <img src="../../main/resources/static/images/explorer.png"
                                    style="height: auto;width: 100%;border-radius: 99px;" v-else>
                            </figure>
